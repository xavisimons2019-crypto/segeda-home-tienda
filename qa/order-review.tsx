...
function Lab(){
 ...
 const simulateTouch=async(far=false)=>{
  ...
  const indicator=document.querySelector('.product-drag-preview>div:last-child small')?.textContent;
